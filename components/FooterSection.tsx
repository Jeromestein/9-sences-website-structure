...
export default function FooterSection({ className = "" }: FooterSectionProps) {
    return (
        <footer className={`w-full py-8 border-t border-amber/20 bg-background ${className}`}>
            <div className="px-8 md:px-12 lg:px-16 max-w-screen-xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center text-xs text-amber/60 uppercase tracking-widest gap-4">
                    <p>© {new Date().getFullYear()} 9Sences. All rights reserved.</p>
                    <a href="mailto:9sences@gmail.com" className="cursor-pointer hover:text-amber transition-colors">
                        9sences@gmail.com
                    </a>
