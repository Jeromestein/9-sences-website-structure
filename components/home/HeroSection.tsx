...
export default function HeroSection() {
    return (
        <section className="relative min-h-[200vh] w-full text-foreground">
            <div className="sticky top-0 flex h-screen w-full flex-col justify-between p-8 md:p-12 lg:p-16">
