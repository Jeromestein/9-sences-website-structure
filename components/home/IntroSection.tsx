...
export default function IntroSection() {
    return (
        <section className="w-full py-24 md:py-32 px-8 md:px-12 lg:px-16 text-foreground border-b border-foreground/10">
            <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
                <div className="md:col-span-4">
                    <motion.h3
                        ...
                        className="font-serif text-2xl md:text-3xl text-foreground font-medium"
                    >
                        What Is 9Sences
                    </motion.h3>
                </div>
                ...
                <div className="md:col-span-8">
                    <motion.div
                        ...
                        className="text-xl md:text-2xl lg:text-3xl font-normal leading-relaxed space-y-8 text-foreground"
                    >
                        <p>
